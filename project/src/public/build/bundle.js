...
var updateStore = function updateStore(store, newState) {
  store = Object.assign(store, newState);
  render(root, store);
};

var render = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(root, state) {
...
var ImageOfTheDay = function ImageOfTheDay(apod) {
  ...
  if (apod.media_type === "video") {
    ...
    return "\n            <img src=\"".concat(apod.image.url, "\" height=\"350px\" width=\"100%\" />\n            <p>").concat(apod.image.explanation, "</p>\n        ");
  }
}; // ------------------------------------------------------  API CALLS
// Example API call


var getImageOfTheDay = function getImageOfTheDay(state) {
  var apod = state.apod;
  fetch("http://localhost:3000/apod").then(function (res) {
    return res.json();
  }).then(function (apod) {
